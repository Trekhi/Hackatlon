...
Original file is located at
    https://colab.research.google.com/drive/1VnaR7cQz_6dIy-l7LjlvarzxvgMX8xI9
"""
...
modelo = tf.keras.Sequential([
  ...
  tf.keras.layers.Dense(50, activation=tf.nn.relu),
  tf.keras.layers.Dense(3, activation=tf.nn.softmax)  # 3 clases en la capa de salida
])
...
imagen = imagenes_prueba[1] #AL ser la variable imagenes_prueba solo tiene lo que se le puso en el bloque anterior heheh
